...
<!-- search-scripts -->
		...
		<div class="container">
			<div class="head-top">
				<div class="logo">
					<h1><a href="<?= base_url(); ?>">Car Sales Online</a></h1>
				</div>
		  <div class=" h_menu4">
				<ul class="memenu blue">
					<li><a class="color8" href="http://localhost/mobil/">Home</a></li>	
					<li><a class="color4" href="<?php echo base_url('login'); ?>">Login Admin</a></li>
			  </ul> 
			</div>
